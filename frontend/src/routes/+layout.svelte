...
{#if checkingSession}
  <div class="flex items-center justify-center min-h-screen bg-brand-deep text-white">
    <div class="flex flex-col items-center gap-4">
      <div class="animate-spin rounded-full h-10 w-10 border-t-2 border-brand-cyan"></div>
...
{:else}
  {#if shouldShowLayout}
    <div class="flex h-screen bg-brand-deep text-white">
      <!-- Sidebar -->
      <aside class="w-64 bg-brand-surface-1 border-r border-brand-surface-2 flex flex-col">
        <!-- Logo -->
